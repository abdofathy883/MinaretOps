...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260322151428_ExtendPortfolioToBeMultilingual")]
    partial class ExtendPortfolioToBeMultilingual
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.Announcement", b =>
                {
                    ...
                    b.ToTable("Announcement", "Communication");
                });
            ...
            modelBuilder.Entity("Core.Models.AnnouncementLink", b =>
                {
                    ...
                    b.ToTable("AnnouncementLink", "Communication");
                });
            ...
            modelBuilder.Entity("Core.Models.ClientService", b =>
                {
                    ...
                    b.ToTable("ClientService", "Clients");
                });
            ...
            modelBuilder.Entity("Core.Models.ClientServiceCheckpoint", b =>
                {
                    ...
                    b.ToTable("ClientServiceCheckpoint", "Clients");
                });
            ...
            modelBuilder.Entity("Core.Models.Complaint", b =>
                {
                    ...
                    b.ToTable("Complaint", "Communication");
                });
            ...
            modelBuilder.Entity("Core.Models.CustomContract", b =>
                {
                    ...
                    b.ToTable("CustomContract", "Clients");
                });
            ...
            modelBuilder.Entity("Core.Models.EmployeeOnBoardingInvitation", b =>
                {
                    ...
                    b.ToTable("EmployeeOnBoardingInvitation", "Identity");
                });
            ...
            modelBuilder.Entity("Core.Models.InternalTaskAssignment", b =>
                {
                    ...
                    b.ToTable("InternalTaskAssignment", "Tasks");
                });
            ...
            modelBuilder.Entity("Core.Models.KPIIncedint", b =>
                {
                    ...
                    b.ToTable("KPIIncedint", "HR");
                });

            modelBuilder.Entity("Core.Models.LeadNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.Portfolio.PortfolioCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PortfolioCategory", "Content");
                });

            modelBuilder.Entity("Core.Models.Portfolio.PortfolioCategoryTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PortfolioCategoryTranslation", "Content");
                });

            modelBuilder.Entity("Core.Models.Portfolio.PortfolioItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PortfolioItem", "Content");
                });

            modelBuilder.Entity("Core.Models.Portfolio.PortfolioTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PortfolioTranslation", "Content");
                });
            ...
            modelBuilder.Entity("Core.Models.SalesLead", b =>
                {
                    ...
                    b.Property<string>("CurrentLeadStatus")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<string>("FreelancePlatform")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<string>("NeedsExpectation")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.ToTable("SalesLead", "CRM");
                });

            modelBuilder.Entity("Core.Models.SalesLeadHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SalesLeadHistory", "CRM");
                });
            ...
            modelBuilder.Entity("Core.Models.ServiceCheckpoint", b =>
                {
                    ...
                    b.ToTable("ServiceCheckpoint", "Services");
                });
            ...
            modelBuilder.Entity("Core.Models.TaskCompletionResources", b =>
                {
                    ...
                    b.ToTable("TaskCompletionResources", "Tasks");
                });
            ...
            modelBuilder.Entity("Core.Models.TaskItemHistory", b =>
                {
                    ...
                    b.ToTable("TaskItemHistory", "Tasks");
                });
            ...
            modelBuilder.Entity("Core.Models.Portfolio.PortfolioCategoryTranslation", b =>
                {
                    b.HasOne("Core.Models.Portfolio.PortfolioCategory", "PortfolioCategory")
            ...
            modelBuilder.Entity("Core.Models.Portfolio.PortfolioItem", b =>
                {
                    b.HasOne("Core.Models.Portfolio.PortfolioCategory", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Core.Models.Portfolio.PortfolioCategory", null)
            ...
            modelBuilder.Entity("Core.Models.Portfolio.PortfolioTranslation", b =>
                {
                    b.HasOne("Core.Models.Portfolio.PortfolioItem", "PortfolioItem")
                        .WithMany("Translations")
            ...
            modelBuilder.Entity("Core.Models.SalesLeadHistory", b =>
                {
                    b.HasOne("Core.Models.SalesLead", "SalesLead")
                        .WithMany("LeadHistory")
